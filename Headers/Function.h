...
inline bool LineRect(const LINE& _L1, const D3DXVECTOR3* pSquare)
{
	LINE line1 = _L1;
	LINE line2;
	...
	bool left = LineDection(line1, line2);

	line2.startPoint = pSquare[2];
	line2.endPoint = pSquare[3];
	bool right = LineDection(line1, line2);

	line2.startPoint = pSquare[0];
	line2.endPoint = pSquare[2];
	bool top = LineDection(line1, line2);

	line2.startPoint = pSquare[1];
	line2.endPoint = pSquare[3];
	bool bottom = LineDection(line1, line2);
