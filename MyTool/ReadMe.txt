...
res\Toolbar.bmp
    ...
    초기 도구 모음과 상태 표시줄은 CMainFrame 클래스에서 생성됩니다. 이 도구 모음 비트맵을 리소스 편집기로 편집하고, MyTool.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 문서 형식과 뷰를 한 개씩 만듭니다.

MyToolDoc.h, MyToolDoc.cpp - 문서
    이 파일에는 CMyToolDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CMyToolDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.

MyToolView.h, MyToolView.cpp - 문서 뷰
    이 파일에는 CMyToolView 클래스가 포함됩니다.
    CMyToolView 개체는 CMyToolDoc 개체를 보는 데 사용됩니다.
